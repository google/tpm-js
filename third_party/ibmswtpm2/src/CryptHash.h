...
typedef const struct _HASH_METHODS
{
...
#endif
typedef const struct _HASH_DEF
{
    HASH_METHODS         method;
    uint16_t             blockSize;
    uint16_t             digestSize;
