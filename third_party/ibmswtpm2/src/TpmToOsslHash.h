...
#define HASH_START_METHOD_DEF   int (HASH_START_METHOD)(PANY_HASH_STATE state)
#define HASH_START(hashState)						\
    ((hashState)->def->method.start)(&(hashState)->state);
/* Add data to the hash */
#define HASH_DATA_METHOD_DEF						\
    int (HASH_DATA_METHOD)(PANY_HASH_STATE state,			\
			    PCBYTE buffer,				\
			    size_t size)
...
#define HASH_END_METHOD_DEF						\
    int (HASH_END_METHOD)(BYTE *buffer, PANY_HASH_STATE state)
